            ...
            <Box sx={{ position: 'relative', zIndex: 2, display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <ScrollReveal animation="grow" timeout={1000}>
                    <Grid container width='100%' marginTop={5} height='100%' justifyContent='center' sx={{ paddingX: 1 }}>
                        ...
                        <Grid item md={12} sm={12} marginBottom={5} sx={{ backgroundColor: 'rgba(243, 239, 239, 1)' }} display='flex' flexDirection='column' width='100%' borderRadius={5} backgroundColor='#f6f6f6'>
                            ...
                            <Box display='flex' justifyContent='center' width='100%' marginBottom={2}>
                                <Box>
                                    ...
                                    // onClick={() => { SubmitForm() }} 
                                    size="large" sx={{ bgcolor: ContactColor, fontWeight: 'bold', textTransform: 'none', borderRadius: '20px', marginX: 1, paddingX: 5, paddingY: 1, fontSize: 13 }}>Submit</Button>
                                </Box>
                            </Box>
                        </Grid>
                    </Grid>
