...
export const MobileView = ({
  ...
  const handleHospitalClick = () =>
    setOpenHospitalDropdown(!openHospitalDropdown);

  const handleContactClick = () => setOpenContactDropdown(!openContactDropdown);

  const handleAboutClick = () => setOpenAboutDropdown(!openAboutDropdown);
              ...
              if (item.name === "Hospitals") {
                  ...
                  <Box key="Aout Us">
                    ...
                    >
                      <Box>
                        ...
                        >
                          <Link href="/governing_council" passHref legacyBehavior>
                            <Box display="flex" alignItems="center">
                              {/* <RiContactsLine size={24} color="gray" /> */}
                              <Typography ml={1} color="#454545">
                                Governing Council
                ...
                return (
                  <Link
                    ...
                    legacyBehavior
                  >
                    <ListItem component="div" onClick={handleClose}>
